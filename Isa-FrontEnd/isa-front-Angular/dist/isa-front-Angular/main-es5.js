...
var AppComponent = /** @class */ (function () {
    function AppComponent(cart, location, rout) {
        this.cart = cart;
        this.rout = rout;
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.rout.events.subscribe(function (ev) {
    ...
    AppComponent.prototype.cartLength = function () {
        if (localStorage.getItem('cart') != null) {
            var lenght = Object.keys(this.cart.getproducts()).length;
...
var BtnFloatComponent = /** @class */ (function () {
    function BtnFloatComponent(serv) {
        this.serv = serv;
        this.divisa = false;
        this.open = false;
        this.click = true;
...
var CarComponent = /** @class */ (function () {
    function CarComponent(cart, serv, dialog) {
        this.cart = cart;
        this.serv = serv;
        this.dialog = dialog;
        this.cesta = [];
    ...
    CarComponent.prototype.getProduct = function () {
        var _this = this;
        if (localStorage.getItem('cart') != null) {
            this.loading = true;
            this.serv.getConfig(1).subscribe(function (req) {
                _this.Usd = Object(req).dolarPrice;
                _this.getProducts();
            });
        }
    };
    CarComponent.prototype.getProducts = function () {
        var _this = this;
        var cart = this.cart.getproducts();
        this.cestaLenght = Object.keys(this.cart).length;
        cart.forEach(function (element) {
            _this.serv.getProduct(element.id).subscribe(function (req) {
                _this.loading = false;
                var temp = {
                    ...
                    img: element.img,
                    priceS: _pipes_priceReal_price_pipe__WEBPACK_IMPORTED_MODULE_6__["PricePipe"].prototype.transform(element.priceS, Object(req), _this.Usd),
                    priceSD: _pipes_priceReal_price_pipe__WEBPACK_IMPORTED_MODULE_6__["PricePipe"].prototype.transform(element.priceSD, Object(req), _this.Usd),
                    stock: element.stock
                };
                _this.cesta.push(temp);
            });
        });
    };
    // calcular(){
    ...
    //   }
    // }
    CarComponent.prototype.edit = function (item) {
        var _this = this;
        this.cesta = [];
        var dialogRef = this.dialog.open(_car_edit_product_edit_product_component__WEBPACK_IMPORTED_MODULE_4__["EditProductComponent"], {
            width: '250px',
            data: item
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result != null) {
                _this.cart.editproduct(result);
                _this.getProduct();
            }
        });
    };
    CarComponent.prototype.delete = function (id) {
        this.cart.deleteproduct(id);
        this.serv.openDialog("Producto eliminado", "Ok");
        this.cesta = this.cart.getproducts();
    };
    CarComponent.prototype.allBs = function () {
        this.cart.allBs();
        this.cesta = [];
        this.cesta = this.cart.getproducts();
        this.getProduct();
    };
    CarComponent.prototype.allDolar = function () {
        this.cesta = [];
        this.cart.allDolar();
        this.cesta = this.cart.getproducts();
        this.getProduct();
    };
    CarComponent.prototype.deleteAll = function () {
...
var EditProductComponent = /** @class */ (function () {
    function EditProductComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    EditProductComponent.prototype.onNoClick = function () {
...
var DetailComponent = /** @class */ (function () {
    function DetailComponent(serv, rout, activdeR, cart, dialog) {
        this.serv = serv;
        this.rout = rout;
    ...
    DetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        var params = this.activdeR.snapshot.params;
        if (params.id) {
            this.loading = true;
            this.serv.getProduct(params.id).subscribe(function (req) {
                _this.loading = false;
                _this.product = req;
                console.log(_this.product);
                _this.product.infoAdd = JSON.parse(_this.product.infoAdd);
                if (_this.product.tags != null) {
                    _this.tags = JSON.parse(_this.product.tags);
                }
            }, function (err) { return console.error(err); });
        }
        this.getConvert();
    };
    DetailComponent.prototype.getConvert = function () {
        var _this = this;
        this.serv.getConfig(1).subscribe(function (req) {
            _this.Usd = Object(req).dolarPrice;
        });
    ...
    DetailComponent.prototype.getCategory = function () {
        var _this = this;
        this.serv.getCategorys().subscribe(function (req) {
            _this.categorys = req;
        });
    };
    DetailComponent.prototype.openDialog = function (item) {
        var dialogRef = this.dialog.open(src_app_dialog_btn_comprar_btn_comprar_component__WEBPACK_IMPORTED_MODULE_5__["BtnComprarComponent"], {
            width: '450px',
            data: item
        });
        dialogRef.afterClosed().subscribe(function (result) {
...
var InicioComponent = /** @class */ (function () {
    function InicioComponent(serv, orderPipe, dialog, location) {
        this.serv = serv;
    ...
    InicioComponent.prototype.getConvert = function () {
        var _this = this;
        this.serv.getConfig(1).subscribe(function (req) {
            _this.Usd = Object(req).dolarPrice;
        });
    };
    InicioComponent.prototype.getcategorys = function () {
        var _this = this;
        this.serv.getCategorys().subscribe(function (req) {
            _this.categorys = req;
        });
    };
    InicioComponent.prototype.getPromDia = function () {
        var _this = this;
        this.serv.getDiaProm().subscribe(function (req) {
            _this.promoDia = req;
        });
    };
    InicioComponent.prototype.getProudctData = function () {
        var _this = this;
        this.serv.getProducts().subscribe(function (req) {
            var data = [];
            data = req;
            _this.products = _this.orderPipe.transform(data, 'updated_at');
            var ult = Object.keys(_this.products).length;
            _this.products.splice(6, ult);
            _this.products.forEach(function (element) {
                if (element.promo = 1) {
                    _this.productDestac = element;
                }
            });
        });
    };
    InicioComponent.prototype.getPromoData = function () {
        var _this = this;
        this.serv.getPromo().subscribe(function (req) {
            var data = [];
            data = req;
            _this.promo = _this.orderPipe.transform(data, 'updated_at');
            var ult = Object.keys(_this.promo).length;
            _this.promo.splice(6, ult);
            _this.promo.forEach(function (element) {
                if (element.promo = 1) {
                    _this.promoDestac = element;
                }
            });
        });
    };
    InicioComponent.prototype.comparaModal = function (item) {
        var dialogRef = this.dialog.open(_dialog_btn_comprar_btn_comprar_component__WEBPACK_IMPORTED_MODULE_5__["BtnComprarComponent"], {
            width: '450px',
            data: item
        });
        dialogRef.afterClosed().subscribe(function (result) {
    ...
    InicioComponent.prototype.divisaChange = function (e) {
        this.divisa = e;
    };
...
var SliderPostComponent = /** @class */ (function () {
    function SliderPostComponent(serv) {
        this.serv = serv;
        this.products = [];
    }
    SliderPostComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.serv.getProducts().subscribe(function (req) {
            for (var i = 0; i < 15; i++) {
                var randomItem = Object(req)[Math.random() * Object(req).length | 0];
                _this.products.push(randomItem);
            }
        });
    };
    SliderPostComponent.ctorParameters = function () { return [
        { type: src_app_services_isa_backend_data_service__WEBPACK_IMPORTED_MODULE_2__["IsaBackendDataService"] }
    ]; };
...
var CustomModModule = /** @class */ (function () {
    function CustomModModule() {
    }
...
var HomeSliderComponent = /** @class */ (function () {
    function HomeSliderComponent(rout, location) {
        this.rout = rout;
        this.location = location;
    }
    ...
    HomeSliderComponent.prototype.route = function () {
        this.rout.navigate(['/productos']);
    };
    HomeSliderComponent.prototype.init = function () {
        var revapi1, tpj;
        tpj = jQuery;
        jQuery(function () {
    ...
    HomeSliderComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var PromocionesComponent = /** @class */ (function () {
    function PromocionesComponent(serv) {
        this.serv = serv;
        this.productos = [];
        this.categorys = [];
        this.divisa = false;
    ...
    PromocionesComponent.prototype.getPromo = function () {
        var _this = this;
        this.serv.getPromo().subscribe(function (req) {
            _this.productos = req;
        });
    };
    PromocionesComponent.prototype.divisaChange = function (e) {
        this.divisa = e;
    };
    PromocionesComponent.ctorParameters = function () { return [
        { type: src_app_services_isa_backend_data_service__WEBPACK_IMPORTED_MODULE_2__["IsaBackendDataService"] }
    ]; };
...
var TodosComponent = /** @class */ (function () {
    function TodosComponent(serv, dialog) {
        this.serv = serv;
        this.dialog = dialog;
        this.productos = [];
        this.categorys = [];
    ...
    TodosComponent.prototype.getConvert = function () {
        var _this = this;
        this.serv.getConfig(1).subscribe(function (req) {
            _this.Usd = Object(req).dolarPrice;
        });
    };
    TodosComponent.prototype.divisaChange = function (e) {
        this.divisa = e;
    };
    TodosComponent.prototype.openDialog = function (item) {
        var dialogRef = this.dialog.open(_dialog_btn_comprar_btn_comprar_component__WEBPACK_IMPORTED_MODULE_4__["BtnComprarComponent"], {
            width: '450px',
            data: item
        });
        dialogRef.afterClosed().subscribe(function (result) {
    ...
    TodosComponent.prototype.getProduct = function () {
        var _this = this;
        this.loding = true;
        this.serv.getProducts().subscribe(function (req) {
            _this.productos = req;
    ...
    TodosComponent.prototype.getCategorys = function () {
        var _this = this;
        this.serv.getCategorys().subscribe(function (req) {
            _this.categorys = req;
        });
...
var BtnComprarComponent = /** @class */ (function () {
    function BtnComprarComponent(serv, cart, dialogRef, data) {
        this.serv = serv;
        this.cart = cart;
        this.dialogRef = dialogRef;
        this.data = data;
    ...
    BtnComprarComponent.prototype.getConvert = function () {
        var _this = this;
        this.loding = true;
        this.serv.getConfig(1).subscribe(function (req) {
            _this.Usd = Object(req).dolarPrice;
            _this.data.priceS = _pipes_priceReal_price_pipe__WEBPACK_IMPORTED_MODULE_5__["PricePipe"].prototype.transform(_this.data.priceS, _this.data, _this.Usd);
            _this.data.priceSD = _pipes_priceReal_price_pipe__WEBPACK_IMPORTED_MODULE_5__["PricePipe"].prototype.transform(_this.data.priceSD, _this.data, _this.Usd);
            _this.loding = false;
        });
    };
    BtnComprarComponent.prototype.ngOnInit = function () {
        this.getConvert();
    };
    BtnComprarComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
        this.cancel = true;
    };
    BtnComprarComponent.prototype.comprar = function (form) {
    ...
    BtnComprarComponent.ctorParameters = function () { return [
...
var BsPipe = /** @class */ (function () {
    ...
    BsPipe.prototype.transform = function (value, stock, tipo) {
        if (value == 0) {
            return "0";
        }
        else {
...
var CategoryPipe = /** @class */ (function () {
    ...
    CategoryPipe.prototype.transform = function (value, category) {
...
var FilterProductPipe = /** @class */ (function () {
    ...
    FilterProductPipe.prototype.transform = function (value, arg) {
        var e_1, _a;
        if (arg == '' || arg.length < 3)
            return value;
        var getProduct = [];
...
var PricePipe = /** @class */ (function () {
    ...
    PricePipe.prototype.transform = function (value, obj, Usd) {
        var caso;
...
var PruebaComponent = /** @class */ (function () {
    ...
    PruebaComponent.prototype.ngOnInit = function () {
        ...
        this.serv.addSlider(this.enviar).subscribe(function (req) {
            console.log(req);
        });
    };
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.addproduct = function (product) {
        ...
        if (localStorage.getItem('cart') == null) {
            ...
            var stringCrypted = crypto_js__WEBPACK_IMPORTED_MODULE_2__["AES"].encrypt(JSON.stringify(this.product), this.cryptoKey).toString();
            localStorage.setItem('cart', stringCrypted);
        }
        else {
            this.product = [];
            var newArr = this.getproducts();
            newArr.push(product);
            var stringCrypted = crypto_js__WEBPACK_IMPORTED_MODULE_2__["AES"].encrypt(JSON.stringify(newArr), this.cryptoKey).toString();
            localStorage.setItem('cart', stringCrypted);
        }
    };
    CartService.prototype.deleteproduct = function (product) {
        ...
        for (var i = 0; i < Object.keys(arr).length; i++) {
            if (product.id == arr[i].id) {
                arr.splice(i, 1);
                var stringCrypted = crypto_js__WEBPACK_IMPORTED_MODULE_2__["AES"].encrypt(JSON.stringify(arr), this.cryptoKey).toString();
                localStorage.setItem('cart', stringCrypted);
            }
        }
    };
    CartService.prototype.editproduct = function (product) {
        var arr = [];
        arr = this.getproducts();
    ...
    CartService.prototype.deleteAllproduct = function () {
        var arr = this.getproducts();
        arr.splice(0, 50);
        var stringCrypted = crypto_js__WEBPACK_IMPORTED_MODULE_2__["AES"].encrypt("[]", this.cryptoKey).toString();
        localStorage.setItem('cart', stringCrypted);
    };
    /* Totales */
    CartService.prototype.addTotales = function (totales) {
        this.totales = [];
        this.totales.push(totales);
        var stringCrypted = crypto_js__WEBPACK_IMPORTED_MODULE_2__["AES"].encrypt(JSON.stringify(this.totales), this.cryptoKey).toString();
        localStorage.setItem('totales', stringCrypted);
    };
    CartService.prototype.getTotales = function () {
    ...
    CartService.prototype.allBs = function () {
        var Arr = this.getproducts();
        Arr.forEach(function (element) {
            if (element.divisa) {
    ...
    CartService.prototype.allDolar = function () {
        var Arr = this.getproducts();
        Arr.forEach(function (element) {
            if (!element.divisa) {
                element.divisa = true;
    ...
    CartService.prototype.deleteAllTotales = function () {
...
var IsaBackendDataService = /** @class */ (function () {
    function IsaBackendDataService(http, _snackBar) {
        this.http = http;
        this._snackBar = _snackBar;
        this.URI = 'http://pruebas.clinicasanjuanbosco.com/db_isa_front/public/api';
    }
    IsaBackendDataService.prototype.getProducts = function () {
        return this.http.get(this.URI + "/productos");
    };
    IsaBackendDataService.prototype.getProduct = function (id) {
        return this.http.get(this.URI + "/productos/" + id);
    };
    IsaBackendDataService.prototype.getCategorys = function () {
        return this.http.get(this.URI + "/categorias");
    };
    IsaBackendDataService.prototype.openDialog = function (message, action) {
        this._snackBar.open(message, action, {
            duration: 4000,
        });
    };
    IsaBackendDataService.prototype.getDiaProm = function () {
        return this.http.get(this.URI + "/prom_dia");
    };
    IsaBackendDataService.prototype.getPromo = function () {
        return this.http.get(this.URI + "/promo");
    };
    IsaBackendDataService.prototype.getsliders = function () {
        return this.http.get(this.URI + "/slider");
    };
    IsaBackendDataService.prototype.addSlider = function (item) {
        return this.http.post(this.URI + "/slider", item);
    };
    IsaBackendDataService.prototype.getConfig = function (id) {
        return this.http.get(this.URI + "/config/1");
    };
    IsaBackendDataService.ctorParameters = function () { return [
